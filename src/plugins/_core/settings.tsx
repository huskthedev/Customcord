...
export default definePlugin({
    ...
    makeSettingsCategories(SectionTypes: SectionTypes) {
        return [
            ...
            {
                section: "CustomcordSettings",
                label: "Customcord",
                element: VencordTab,
                className: "vc-settings"
            },
            {
                section: "CustomcordPlugins",
                label: "Plugins",
                element: PluginsTab,
                className: "vc-plugins"
            },
            {
                section: "CustomcordThemes",
                label: "Themes",
                element: ThemesTab,
                className: "vc-themes"
            },
            !IS_UPDATER_DISABLED && {
                section: "CustomcordUpdater",
                label: "Updater",
                element: () => [],
                className: "vc-updater"
            },
            {
                section: "CustomcordBackupAndRestore",
                label: "Backup & Restore",
                element: BackupAndRestoreTab,
                className: "vc-backup-restore"
            },
            IS_DEV && {
                section: "CustomcordPatchHelper",
                label: "Patch Helper",
